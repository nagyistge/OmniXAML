namespace OmniXaml.ObjectFactories
{
    ...
    public class TypeMatchingObjectFactory : IObjectFactory
    {
        ...
        private static bool SameName(ParameterInfo parameterInfo, InjectableValue injectableValue)
        {
            var typeOfParameter = parameterInfo.ParameterType.GetTypeInfo();
            return typeOfParameter.IsAssignableFrom(injectableValue.Value.GetType());
        }
    }
}